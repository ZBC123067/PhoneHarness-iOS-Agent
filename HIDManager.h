...
/// the existing broadcast path. Experiment build only — not part of the
/// production input contract.
- (void)expKeyboardTapWithPage:(uint32_t)page usage:(uint32_t)usage completion:(void (^)(BOOL success, NSString *error))completion;
