...
// Determine whether a concrete attribute on this exact AX element is writable.
typedef AXError (*AXUIElementIsAttributeSettableFunc)(AXUIElementRef element, CFStringRef attribute, Boolean *settable);
